...
int main()
{
    ...
    model_info info;
    shader_asset_info fragShader { "res/shaders/sample/normal_map_frag.glsl", shaderType::fragment};
    shader_asset_info vertShader { "res/shaders/sample/normal_map_vert.glsl", shaderType::vertex};
