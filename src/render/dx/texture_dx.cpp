...
void texture_dx::uploadData(modelViewer::render::texture_setup& texture_setup, Microsoft::WRL::ComPtr<ID3D12Device>& 
    device,
...
void texture_dx::createTextureFromRawData(modelViewer::render::texture_setup& setup,
...
DXGI_FORMAT texture_dx::getTextureFormat(std::shared_ptr<modelViewer::res::texture_asset>& texture, bool compressed)
{
