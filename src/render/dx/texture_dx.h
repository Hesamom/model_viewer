...
namespace modelViewer::render::dx
{
    ...
    protected:
        void uploadData(texture_setup& texture_setup, Microsoft::WRL::ComPtr<ID3D12Device>& device,
    ...
    private:
        DXGI_FORMAT getTextureFormat(std::shared_ptr<res::texture_asset>& sharedPtr, bool compressed);
